...
@section('title', 'Asignar Grupo - Admin')
...
<div class="max-w-6xl mx-auto">
    <div class="bg-white shadow-xl rounded-2xl border border-deep-teal-200 overflow-hidden">
        ...
        <div class="p-4 sm:p-6 bg-gradient-to-br from-gray-25 to-deep-teal-25">
            <form action="{{ route('admin.materias.store-asignar-grupo', $materia->sigla) }}" method="POST" id="asignacionForm">
                @csrf
                        ...
                        <div class="text-center">
                            ...
                            @php
                                ...
                                foreach($materia->grupoMaterias as $grupoMateria) {
                                    $docentesCount += $grupoMateria->horarios->unique('codigo_docente')->count();
                                }
                            @endphp
...
$(document).ready(function() {
    actualizarResumen();
    $('#aulas-count').text('{{ $aulas->count() }} disponibles');
    $('#horarios-count').text('{{ $horarios->count() }} disponibles');
});
</script>
@endpush